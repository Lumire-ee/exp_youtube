...
function Aside() {
  ...
  return (
    <aside className="sticky top-16 z-40 flex h-[calc(100vh-4rem)] w-16 flex-col items-center space-y-3 py-2">
      <button
        onClick={() => handleButtonClick('home')}
        className={`flex size-14 flex-col items-center justify-center rounded-lg hover:bg-gray-200`}>
        <House
          size={24}
          className={`${
